...
(function ($) {
  ...
  setTimeout(function () {
      if (window.___browserSync___ === undefined && Number(localStorage.getItem('Welcome:Demo:MessageShowed')) < Date.now()) {
        localStorage.setItem('Welcome:Demo:MessageShowed', (Date.now()) + (15 * 60 * 1000))
